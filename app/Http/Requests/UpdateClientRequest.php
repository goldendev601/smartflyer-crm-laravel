...
//            'client_phone' => 'nullable|phone:1:AUTO,US',
            ...
            'client_phone' => [ 'required','nullable', 'max:30', new PhoneNumberValidationRule() ],
        ...
        if ($this->route()->getName() == 'updateclient' || $this->route()->getName() == 'delegateUpdateClient') {
    ...
    public function messages()
    {
        return
            [
                ...
                'rc_relationship.*.required' => 'Relationship is required.',
                'rc_dobM.*.required' => 'Please select month.',
                'rc_dobD.*.required' => 'Please select day.',
                'rc_dobY.*.required' => 'Please select year.',
                'impd_dobM.*.required' => 'Please select month.',
                'impd_dobD.*.required' => 'Please select day.',
                'impd_dobY.*.required' => 'Please select year.',
            ];
    }
}
